        ...
        <main>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-around">
                    ...
                    >
                        ...
                        {property.rates.nightly ? <div className="text-2xl font-bold">${property.rates.nightly.toLocaleString()} </div> : <FaTimes className="text-red-700" />
                        }
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                >{property.amenities.map((amenity, index) => <li>
                    <FaCheck className="text-green-600 mr-2 mt-3" key={index} /> {amenity}
                </li>)
